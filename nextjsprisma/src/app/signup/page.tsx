        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4">
            <div className="relative mx-auto max-w-[525px] overflow-hidden rounded-lg px-10 py-16 text-center dark:bg-dark-2 sm:px-12 md:px-[60px]">
              ...
              <a
                href="/#"
                className="mb-2 inline-block text-base text-dark hover:text-primary hover:underline dark:text-blue-500"
              >
                Forget Password?
              </a>
              <p className="text-base text-body-color dark:text-dark-6 text-primary hover:underline text-blue-300">
