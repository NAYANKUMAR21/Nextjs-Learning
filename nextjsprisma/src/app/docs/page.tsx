const Docs = () => {
  return (
    <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32 h-screen flex flex-col justify-center">
      <img
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 z-10 text-center">
